    ...
    public partial class SiteMaster : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqliteConnection db = new SqliteConnection("Filename=DB.db"))
            {
                ...
                db.Open();
                string tableCommandProducts = "CREATE TABLE IF NOT EXISTS Products (ID INTEGER PRIMARY KEY, Name NVARCHAR(2048), Details NVARCHAR(2048), " +
                    "Vendor NVARCHAR(2048), Image NVARCHAR(2048), Portions INTEGER, Preferences NVARCHAR(2048), Active INTEGER," +
